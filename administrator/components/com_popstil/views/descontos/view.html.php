...
class PopstilViewDescontos extends JViewLegacy {
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('Gerenciar Descontos'));
		
	}
	
	protected function addToolBar() 
	{
		JToolBarHelper::title('Gerenciar Descontos');
		//JToolBarHelper::deleteList('', 'descontos.delete');
		JToolBarHelper::deleteList('', 'descontos.delete');
		JToolBarHelper::editList('desconto.edit');
		JToolBarHelper::addNew('desconto.add');
	}
	/**
	 * Setting the toolbar
	 */
