...
<script type="text/javascript">
	...
	{
		if (task == 'usuario.cancel' || document.formvalidator.isValid(document.id('usuario-form')))
		{
			Joomla.submitform(task, document.getElementById('usuario-form'));
		}
	}
</script>

<form action="<?php echo JRoute::_('index.php?option=com_popstil&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="usuario-form" class="form-validate form-horizontal" enctype="multipart/form-data">
