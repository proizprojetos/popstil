...
<form action="<?php echo JRoute::_('index.php?option=com_popstil&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slider-form" class="form-validate form-horizontal" enctype="multipart/form-data">
