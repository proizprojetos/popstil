...
//			$query[] = "UPDATE #__extensions SET ordering = -2147483800 WHERE element='option=com_jnews'";
	...
	//create cron
	//we call the function from cron.jnews.php controller file
	//to be removed #7992234
...
function installMenu(){
	...
	//to be removed # 20891234
	,'SMART-NEWSLETTERS','AUTO-RESPONDERS'
	);
	...
	//to be removed # 20891234
	,_JNEWS_MENU_AUTONEWS,_JNEWS_MENU_AUTOS
	);
...
function installExtensions(){
		...
		//line to be removed code #768345
		$extensioninfo['jnewsjomsocial'] = array('jNews JomSocial Plugin',4,'#__community_users');

		//inclusion of module in newsletter
		//line to be removed # 9033982923
		$extensioninfo['tagmodule'] = array('jNews Tag: Joomla Modules',1,1);
		$extensioninfo['jnewscron'] =  array('jNews Cron Plugin',5,1);
...
function com_uninstall() {
	...
	if ( !defined('DS') ) define( 'DS', DIRECTORY_SEPARATOR );
	if(file_exists( JNEWS_JPATH_ROOT . DS.'components'.DS.'com_jnews'.DS.'defines.php')) {
		require_once( JNEWS_JPATH_ROOT . DS.'components'.DS.'com_jnews'.DS.'defines.php');
...
function removeBots() {   
	...
	$bot_infos = array('jnewsbot','module','tagdatetime','tagmodule','tagsite','tagsubscriber','tagsubscription','forwardtofriend','virtuemartproduct','jnewsbotk2','jnewsjomsocial','jnewsshare');
