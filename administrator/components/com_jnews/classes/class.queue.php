				...
				if ( !empty($listOfAdminA) )
					...
					foreach( $listOfAdminA as $oneAdmin )
						...
						if ( empty($oneAdmin) )  continue;
                                ...
                                {
                                        if( version_compare(JVERSION,'3.0.0','<') ){
                                            JUTility::sendMail( $admin->email, $admin->username, $admin->email, $title_email, $send );
                                        }else{
                                          $class_for_mail->sendMail( $admin->email, $admin->username, $admin->email, $title_email, $send );
                                        }
