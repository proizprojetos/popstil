...
INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`, `csstyle`) VALUES (NULL, 'Acajoom Template', 'A simple single column template suitable for any kind of occasions with a clean and sharp designed to align your company''s identity. The default newsletter template mostly used in Acajoom. \r\n', '<table style="width: 100%; margin: 0pt auto; background-color:#f1f1f1; color: #333333;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td align="center" valign="top">
...
INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`, `csstyle`) VALUES (NULL, 'Elegant Navy', 'A unique and beautiful two layout newsletter template designed to present current news and let your customers updated.', '<style type="text/css">
...
INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`, `csstyle`) VALUES (12, 'Simplicity', 'Bring out the best of your content with this light and clean simple newsletter.', '<div style="background-color:#FFFFFF;">
<p> </p>
...
INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Bliss (blue)', 'A blend of perfect yet subtle joy and serenity taken from its clean minimalistic design.', NULL, NULL, NULL, '1', '0', '99', 'bliss_blue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/bliss_blue.png', -1,''),
		(NULL, 'Bliss (green)', 'A blend of perfect yet subtle joy and serenity taken from its clean minimalistic design.', NULL, NULL, NULL, '1', '0', '99', 'bliss_green', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/bliss_green.png', -1,''),
		(NULL, 'Bliss (orange)', 'A blend of perfect yet subtle joy and serenity taken from its clean minimalistic design.', NULL, NULL, NULL, '1', '0', '99', 'bliss_orange', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/bliss_orange.png', -1,''),
		(NULL, 'Bliss (red)', 'A blend of perfect yet subtle joy and serenity taken from its clean minimalistic design.', NULL, NULL, NULL, '1', '0', '99', 'bliss_red', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/bliss_red.png', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Delight (lightgreen)', 'A suitable template suited for your business, personal, organization, or recreational newsletters.', NULL, NULL, NULL, '1', '0', '99', 'delight_lightgreen', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/delight_lightgreen.png', -1,''),
		(NULL, 'Delight (orange)', 'A suitable template suited for your business, personal, organization, or recreational newsletters.', NULL, NULL, NULL, '1', '0', '99', 'delight_orange', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/delight_orange.png', -1,''),
		(NULL, 'Delight (orchid)', 'A suitable template suited for your business, personal, organization, or recreational newsletters.', NULL, NULL, NULL, '1', '0', '99', 'delight_orchid', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/delight_orchid.png', -1,''),
		(NULL, 'Delight (steelblue)', 'A suitable template suited for your business, personal, organization, or recreational newsletters.', NULL, NULL, NULL, '1', '0', '99', 'delight_steelblue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/delight_steelblue.png', -1,''),
		(NULL, 'Delight (thistle)', 'A suitable template suited for your business, personal, organization, or recreational newsletters.', NULL, NULL, NULL, '1', '0', '99', 'delight_thistle', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/delight_thistle.png', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Eldiario (black)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (black) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_black', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_black.png', -1,''),
		(NULL, 'Eldiario (blue)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (blue) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_blue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_blue.png', -1,''),
		(NULL, 'Eldiario (green)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (green) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_green', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_green.png', -1,''),
		(NULL, 'Eldiario (lightblue)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (lightblue) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_lightblue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_lightblue.png', -1,''),
		(NULL, 'Eldiario (lightgreen)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (lightgreen) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_lightgreen', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_lightgreen.png', -1,''),
		(NULL, 'Eldiario (lightred)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (lightred) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_lightred', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_lightred.png', -1,''),
		(NULL, 'Eldiario (red)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (red) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_red', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_red.png', -1,''),
		(NULL, 'Eldiario (white)', 'Engaged your customers with a clean newsletter template, well organize information. El Diario (white) can be used at its best with several contents.', NULL, NULL, NULL, '1', '0', '99', 'eldiario_white', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/eldiario_white.png', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Flare (black)', 'Flame up with, Flare! Flare (black) is a combination of classical yet modern and simple beauty; the level of intensity that your newsletter needs.', NULL, NULL, NULL, '1', '0', '99', 'flare_black', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/flare_black.png', -1,''),
		(NULL, 'Flare (maroon)', 'Flame up with, Flare! Flare (maroon) is a combination of classical yet modern and simple beauty; the level of intensity that your newsletter needs.', NULL, NULL, NULL, '1', '0', '99', 'flare_maroon', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/flare_maroon.png', -1,''),
		(NULL, 'Flare (orange)', 'Flame up with, Flare! Flare (orange) is a combination of classical yet modern and simple beauty; the level of intensity that your newsletter needs.', NULL, NULL, NULL, '1', '0', '99', 'flare_orange', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/flare_orange.png', -1,''),
		(NULL, 'Flare (teal)', 'Flame up with, Flare! Flare (teal) is a combination of classical yet modern and simple beauty; the level of intensity that your newsletter needs.', NULL, NULL, NULL, '1', '0', '99', 'flare_teal', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/flare_teal.png', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Optimum (darkblue)', 'Optimum (darkblue) has a professional touch of modern and futuristic style, driving you to its optimal level. It is designed to guide your eyes to your important newsletter content using good balance of white space.', NULL, NULL, NULL, '1', '0', '99', 'optimum_darkblue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/optimum_darkblue.png', -1,''),
		(NULL, 'Optimum (darkgreen)', 'Optimum (darkgreen) has a professional touch of modern and futuristic style, driving you to its optimal level. It is designed to guide your eyes to your important newsletter content using good balance of white space.', NULL, NULL, NULL, '1', '0', '99', 'optimum_darkgreen', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/optimum_darkgreen.png', -1,''),
		(NULL, 'Optimum (darkred)', 'Optimum (darkred) has a professional touch of modern and futuristic style, driving you to its optimal level. It is designed to guide your eyes to your important newsletter content using good balance of white space.', NULL, NULL, NULL, '1', '0', '99', 'optimum_darkred', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/optimum_darkred.png', -1,''),
		(NULL, 'Optimum (lightblue)', 'Optimum (lightblue) has a professional touch of modern and futuristic style, driving you to its optimal level. It is designed to guide your eyes to your important newsletter content using good balance of white space.', NULL, NULL, NULL, '1', '0', '99', 'optimum_lightblue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/optimum_lightblue.png', -1,''),
		(NULL, 'Optimum (lightgreen)', 'Optimum (lightgreen) has a professional touch of modern and futuristic style, driving you to its optimal level. It is designed to guide your eyes to your important newsletter content using good balance of white space.', NULL, NULL, NULL, '1', '0', '99', 'optimum_lightgreen', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/optimum_lightgreen.png', -1,''),
		(NULL, 'Optimum (lightred)', 'Optimum (lightred) has a professional touch of modern and futuristic style, driving you to its optimal level. It is designed to guide your eyes to your important newsletter content using good balance of white space.', NULL, NULL, NULL, '1', '0', '99', 'optimum_lightred', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/optimum_lightred.png', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Royale (gold)', 'Step aboard and see the timeless form of pattern and style, Royale in gold. Paint your newsletter with royalty to present your pictures and website updates that would leave your customer with nothing but fabulous feelings.', NULL, NULL, NULL, '1', '0', '99', 'royale_gold', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/royale_gold.png', -1,''),
		(NULL, 'Royale (blue)', 'Step aboard and see the timeless form of pattern and style, Royale in blue. Paint your newsletter with royalty to present your pictures and website updates that would leave your customer with nothing but fabulous feelings.', NULL, NULL, NULL, '1', '0', '99', 'royale_blue', NULL,  'http://www.joobi.co/images/newsletter_templates/thumbnails/royale_blue.png', -1,''),
		(NULL, 'Royale (green)', 'Step aboard and see the timeless form of pattern and style, Royale in green. Paint your newsletter with royalty to present your pictures and website updates that would leave your customer with nothing but fabulous feelings.', NULL, NULL, NULL, '1', '0', '99', 'royale_green', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/royale_green.png', -1,''),
		(NULL, 'Royale (red)', 'Step aboard and see the timeless form of pattern and style, Royale in red. Paint your newsletter with royalty to present your pictures and website updates that would leave your customer with nothing but fabulous feelings.', NULL, NULL, NULL, '1', '0', '99', 'royale_red', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/royale_red.png', -1,''),
		(NULL, 'Royale (silver)', 'Step aboard and see the timeless form of pattern and style, Royale in silver. Paint your newsletter with royalty to present your pictures and website updates that would leave your customer with nothing but fabulous feelings.', NULL, NULL, NULL, '1', '0', '99', 'royale_silver', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/royale_silver.png', -1,''),
		(NULL, 'Royale (violet)', 'Step aboard and see the timeless form of pattern and style, Royale in violet. Paint your newsletter with royalty to present your pictures and website updates that would leave your customer with nothing but fabulous feelings.', NULL, NULL, NULL, '1', '0', '99', 'royale_violet', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/royale_violet.png', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Christmas Company', 'Greet your employees, clients or partners a Merry Christmas.', NULL, NULL, 1291654431, '1', '0', '1', 'christmas_company', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/christmas_company.jpg', -1,''),
		(NULL, 'Christmas Family', 'Don''t forget your family and give them a heart-warming white Christmas.', NULL, NULL, 1291654431, '1', '0', '2', 'christmas_family', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/christmas_family.jpg', -1,''),
		(NULL, 'Christmas Friends', 'Bring fun to a snowy yet fun Holiday with your colleagues and friends.', NULL, NULL, 1291654431, '1', '0', '3', 'christmas_friends', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/christmas_friends.jpg', -1,''),
		(NULL, 'Christmas Religion', 'Send the spirit of Christmas and sincere wish to your churchmates, parents, or relatives.', NULL, NULL, 1291654431, '1', '0', '4', 'christmas_religion', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/christmas_religion.jpg', -1,''),
		(NULL, 'Christmas Special', 'Give happiness to your special someone this Christmas.', NULL, NULL, 1291654431, '1', '0', '5', 'christmas_special', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/christmas_special.jpg', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Newyear Company', 'Wish a prosperous New Year to your business, clients and customers.', NULL, NULL, 1291654431, '1', '0', '6', 'newyear_company', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/newyear_company.jpg', -1,''),
		(NULL, 'Newyear Family', 'A heavenly soothing design for your family to put a smile.', NULL, NULL, 1291654431, '1', '0', '7', 'newyear_family', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/newyear_family.jpg', -1,''),
		(NULL, 'Newyear Friends', 'Send a refreshing year greeting specially designed for your friends.', NULL, NULL, 1291654431, '1', '0', '8', 'newyear_friends', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/newyear_friends.jpg', -1,''),
		(NULL, 'Newyear Religion', 'Do you have New Year resolution already? A conservative yet slick designed for your churchmates and friends.', NULL, NULL, 1291654431, '1', '0', '9', 'newyear_religion', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/newyear_religion.jpg', -1,''),
		(NULL, 'Newyear Special', 'Be unforgettable and melt her/his heart this New Year.', NULL, NULL, 1291654431, '1', '0', '10', 'newyear_special', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/newyear_special.jpg', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Unison (purple)', 'Community designed newsletter, also suitable for business, portfolio, personal, organization or crecreational sites.', NULL, NULL, NULL, '1', '0', '99', 'unison_purple', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/unison_purple.jpg', -1,''),
		(NULL, 'Unison (green)', 'Community designed newsletter, also suitable for business, portfolio, personal, organization or crecreational sites.', NULL, NULL, NULL, '1', '0', '99', 'unison_green', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/unison_green.jpg', -1,''),
		(NULL, 'Unison (flesh)', 'Community designed newsletter, also suitable for business, portfolio, personal, organization or crecreational sites.', NULL, NULL, NULL, '1', '0', '99', 'unison_flesh', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/unison_flesh.jpg', -1,''),
		(NULL, 'Unison (brown)', 'Community designed newsletter, also suitable for business, portfolio, personal, organization or crecreational sites.', NULL, NULL, NULL, '1', '0', '99', 'unison_brown', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/unison_brown.jpg', -1,''),
		(NULL, 'Unison (blue)', 'Community designed newsletter, also suitable for business, portfolio, personal, organization or crecreational sites.', NULL, NULL, NULL, '1', '0', '99', 'unison_blue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/unison_blue.jpg', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Compassion Christmas', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_christmas', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_christmas.jpg', -1,''),
		(NULL, 'Compassion Halloween', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_halloween', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_halloween.jpg', -1,''),
		(NULL, 'Compassion Independence', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_independence', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_independence.jpg', -1,''),
		(NULL, 'Compasion Newyear', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_newyear', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_newyear.jpg', -1,''),
		(NULL, 'Compasion Thanksgiving', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_thanksgiving', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_thanksgiving.jpg', -1,''),
		(NULL, 'Compassion Valentines', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_valentines', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_valentines.jpg', -1,''),
		(NULL, 'Compassion Womensday', 'Embrace change with Compassion which is best for photography, portfolio, blog and business newsletters.', NULL, NULL, NULL, '1', '0', '99', 'compassion_womensday', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/compassion_womensday.jpg', -1,'');

INSERT IGNORE INTO `#__jnews_templates` (`template_id`, `name`, `description`, `body`, `altbody`, `created`, `published`, `premium`, `ordering`, `namekey`, `styles`, `thumbnail`, `availability`,`csstyle`)
	VALUES (NULL, 'Silence (blue)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_blue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_blue.jpg', -1,''),
		(NULL, 'Silence (brown)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_brown', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_brown.jpg', -1,''),
		(NULL, 'Silence (darkblue)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_darkblue', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_darkblue.jpg', -1,''),
		(NULL, 'Silence (darkbrown)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_darkbrown', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_darkbrown.jpg', -1,''),
		(NULL, 'Silence (darkgreen)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_darkgreen', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_darkgreen.jpg', -1,''),
		(NULL, 'Silence (darkorange)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_darkorange', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_darkorange.jpg', -1,''),
		(NULL, 'Silence (darkred)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_darkred', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_darkred.jpg', -1,''),
		(NULL, 'Silence (darkviolet)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_darkviolet', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_darkviolet.jpg', -1,''),
		(NULL, 'Silence (green)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_green', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_green.jpg', -1,''),
		(NULL, 'Silence (orange)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_orange', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_orange.jpg', -1,''),
		(NULL, 'Silence (purple)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_purple', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_purple.jpg', -1,''),
		(NULL, 'Silence (red)', 'Highlight the contents with Silence suitable for your portfolio, photo blog, personal, business, organization or recreational newsletter.', NULL, NULL, NULL, '1', '0', '99', 'silence_red', NULL, 'http://www.joobi.co/images/newsletter_templates/thumbnails/silence_red.jpg', -1,'');
