...
DROP TABLE IF EXISTS `#__customizacao_numeropessoas`;
...
CREATE TABLE `#__customizacao_numeropessoas` (
  ...
  `preco` decimal(10,2),
   ...
   FOREIGN KEY (`id_tamanho`) REFERENCES `#__customizacao_tamanhos`(`id_tamanho`)
) ENGINE=MyISAM AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;
...
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(1,1,'30','30','width:35px;height:35px;margin:49px;','3.50',now());
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(2,1,'40','40','width: 56px;height: 56px;margin:38px;','3.50',now());
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(3,1,'60','60','width: 84px;height: 84px;margin:24px','6.00',now());
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(4,1,'80','80','width: 112px;height: 112px;margin:10px','6.00',now());

INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(5,2,'40','30','width: 52px;height: 18px;margin: 48px;','3.50',now());
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(6,2,'50','40','width: 71px;height: 35px;margin: 39px;','3.50',now());
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(7,2,'60','40','width: 99px;height: 61px;margin: 26px;','6.00',now());
INSERT INTO `#__customizacao_tamanhos` (id_tamanho,id_categoria,largura,altura,estilo,peso,dataAlteracao) VALUES(8,2,'80','60','width: 130px;height: 90px;margin: 10px;','6.00',now());
...
INSERT INTO `#__customizacao_molduras` (titulo,url_moldura,dataAlteracao) VALUES('Preta','/media/popstilcustomizacao/moldura1_.png',now());
INSERT INTO `#__customizacao_molduras` (titulo,url_moldura,dataAlteracao) VALUES('Branca','/media/popstilcustomizacao/moldura2_.png',now());




/*tabelas do usuario/cliente*/
DROP TABLE IF EXISTS `#__popstil_usuarios`;
CREATE  TABLE IF NOT EXISTS `#__popstil_usuarios` (
...
CREATE  TABLE IF NOT EXISTS `#__popstil_enderecos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
